...
class AuthPage extends StatefulWidget {
  AuthPage({this.authService, this.loginCallBack});
...
class _AuthPageState extends State<AuthPage> {
  ...
  Widget showLogo() {
    return Padding(
      ...
      child: Image.asset(
        'assets/images/logoalvoaaabm_400x400.jpg',height: 250,width: 250,
      ),
    );
  }

  Widget showInputOptions() {
    return Column(
      children: <Widget>[
        showEmailInput(),
        showPasswordInput(),
        ...
        child: Padding(
          ...
          child: new TextFormField(
            ...
            decoration: new InputDecoration(
                hintText: 'Email',
                hintStyle: TextStyle(color: ConstColors.ccBlueVioletWheel, fontStyle: FontStyle.italic),
                icon: new Icon(
                  Icons.mail,
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: OutlineButton(
                splashColor: Colors.grey,
                onPressed: () {
                  widget.authService.signIn(_emailController.text.toString(),
    ...
    return Padding(
      ...
      child: FlatButton(
          child: Text('Não tem uma conta? Cadastre-se!',
              style: new TextStyle(fontSize: 18.0, fontWeight: FontWeight.w900, color: ConstColors.ccBlueVioletWheel)),
          onPressed: () {
